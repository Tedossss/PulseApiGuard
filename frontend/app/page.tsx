...
export const metadata: Metadata = {
  title: { absolute: 'PulseGuard — API Monitoring' },
  description:
    'Monitor owned HTTP endpoints, confirm incidents after repeated failures, and receive Telegram recovery alerts from one focused dashboard.',
  alternates: { canonical: 'https://falach.pl/PAG' },
  openGraph: {
    type: 'website',
  ...
  return (
    <main className="landing-v2 min-h-screen bg-[#f2f0e8] text-[#11110f] selection:bg-[#b7ff3c]">
      ...
      <nav aria-label="Primary navigation" className="mx-auto flex max-w-[1440px] items-center justify-between border-x-2 border-black px-4 py-4 sm:px-7">
        <a
          href="https://falach.pl/"
          aria-label="PulseGuard — return to the falach.pl portfolio"
